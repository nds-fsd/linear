        ...
        <div className={cardStyles.container}>
            <div className={cardStyles.container1}>
                ...
                <span className={cardStyles.card_image}>
                    <img src="/src/assets/Vector.jpg" alt="flechita" />
                    4</span>
            </div>
            ...
            <div className={cardStyles.container3}>
                <div className={cardStyles.avatar}>
                 ...
                 {/* <input type="file" className={cardStyles.buttonadj}/> */}
                    <img src="/src/assets/vector3.png"alt="file" className={cardStyles.clipAdd}/>
                    <span>2</span>
                    <img className={cardStyles.iconomensaje} src="/src/assets/iconorange.png" alt='iconomensaje' />
                    <span>3</span>
                </div>
            </div>
